...
int obtenerVelocidad1(double *velocidad){
	...
	int escribir, leer;
	escribir = escribirDatos(fdMD49, 2, sbuf);
	if(escribir !=  0){
		#ifdef MD49_DEBUG
...
int asignarVelocidad1(double velocidad1){
	...
	sbuf[2] = velocidad1;
	int escribir;
	escribir = escribirDatos(fdMD49, 3, sbuf);
	if(escribir !=  0){
		#ifdef MD49_DEBUG
